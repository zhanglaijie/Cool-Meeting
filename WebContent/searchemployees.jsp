        ...
        <div class="page-body">
            ...
            <div class="page-content">
                <div class="content-nav">
                 ...
                 <form action="searchEmpAction.action?prove=search" method="post">
                    <fieldset>
                        <legend>搜索会议</legend>
                        <table class="formtable">
                            <tr>
                                <td>姓名：</td>
                                <td>
                                    <input type="text" id="employeename" name = names maxlength="20"/>
                                </td>
                                <td>账号名：</td>
                                <td>
                                    <input type="text" id="accountname" name = ename maxlength="20"/>
                                </td>
                                <td>状态：</td>
                                <td>
                                    <input type="radio" id="status" name=s_privilege value="1" checked="checked"/><label>已批准</label>
                                    <input type="radio" id="status" name=s_privilege value="0"/><label>待审批</label>
                                    <input type="radio" id="status" name=s_privilege value="-1"/><label>已关闭</label>
                                </td>
                            </tr>
                            <tr>
                ...
                <div>
                    ...
                    <div class="pager-header">
                        ...
                        <form action="NextEmpAction.action" method="post">
                ...
                <table class="listtable">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="CloseEmpAction.action?eid=<s:property value="#emp.eid"/>" method="post">
                            <input type="submit" class="clickbutton" value="关闭账号"/>
                            </form>
                        </td>
                    </tr>
                   </s:iterator>
