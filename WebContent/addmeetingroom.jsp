...
<html>
    ...
    function myalet(){
          if ("${requestScope.result}"=="该房间已经存在")
        	  {
                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            <tr>
                                <td>门牌号:</td>
                                <td>
                                    <input id="rid" name="rid" type="text" placeholder="例如：201" maxlength="10"/>
                                </td>
                            </tr>
                            <tr>
                                <td>会议室名称:</td>
                                <td>
                                    <input id="rname" name="rname" type="text" placeholder="例如：第一会议室" maxlength="20"/>
                                </td>
                            </tr>
                            <tr>
                                <td>最多容纳人数：</td>
                                <td>
                                    <input id="maxnum" name="maxnum" type="text" placeholder="填写一个正整数"/>
                                </td>
                            </tr>
                            <tr>
                                <td>当前状态：</td>
                                <td>
                                    <input type="radio" id="rstate" name="rstate" checked="checked" value="1"/><label for="rstate">启用</label>
                                    <input type="radio" id="rstate" name="rstate" value="0"/><label for="rstate" >停用</label>
                                    <input type="radio" id="rstate" name="rstate" value="-1"/><label for="rstate" value="-1">删除</label>
                                </td>
                            </tr>
                            <tr>
                                <td>备注：</td>
                                <td>
                                    <textarea id="rremark" name="rremark" maxlength="200" rows="5" cols="60" placeholder="200字以内的文字描述"></textarea>
                                </td>
                            </tr>
                            <tr>
